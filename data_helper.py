...
The data download website is https://www.cs.toronto.edu/~kriz/cifar.html and the website has a detailed description
of the dataset. The code following is based on https://github.com/wolfib/image-classification-CIFAR10-tf/blob/master
/data_helpers.py.
'''
